...
if !exists("g:tex_no_math")
 ...
 " Change by gerw: If you have something like "\footnote{$a+b$}"
 " in an included file, then the math is not highlighted correctly.
 " Dirty workaround:
 syn cluster texMatchNMGroup		add=@texMathZones
